...
namespace gc
{
    ...
    template<class Key, class T,
        class HashFcn,
        class EqualKey = std::equal_to<Key> >
    class AppendOnlyGCNotDefaultKeyHashMap : public il2cpp::utils::NonCopyable
    {
        typedef Il2CppNotDefaultKeyHashMap<Key, size_t, HashFcn, EqualKey> hash_map_type;
        typedef typename Il2CppNotDefaultKeyHashMap<Key, size_t, HashFcn, EqualKey>::const_iterator ConstIterator;
    public:
        ...
        AppendOnlyGCNotDefaultKeyHashMap() :
            m_Data(NULL),
            m_Size(0)
        {
        }
		...
		void SetUnderlyingHashMapDeleteKey(Key key)
		{
    ...
    private:
        ...
        Il2CppNotDefaultKeyHashMap<Key, size_t, HashFcn, EqualKey> m_Map;
        T* m_Data;
        size_t m_Size;
        os::FastReaderReaderWriterLock lock;
    };
