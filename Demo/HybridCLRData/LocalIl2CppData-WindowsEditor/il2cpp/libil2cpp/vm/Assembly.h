...
// exported
    public:
        ...
        static void GetReferencedAssemblies(const Il2CppAssembly* assembly, AssemblyVector* target);
    public:
        ...
        static const Il2CppAssembly* GetOriginDifferentialHybridAssembly(const char* name);
